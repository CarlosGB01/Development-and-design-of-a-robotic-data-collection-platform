...
int main(int argc, char **argv) {
  ...
  nh.param("delta_width_circles", delta_width_circles_, 0.2);
  nh.param("delta_height_circles", delta_height_circles_, 0.16);
  nh_.param("marker_size", marker_size_, 0.1);
  nh_.param("delta_width_qr_center_", delta_width_qr_center_, 0.21);
  nh_.param("delta_height_qr_center_", delta_height_qr_center_, 0.13);
